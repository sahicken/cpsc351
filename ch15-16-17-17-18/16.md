# Homework (Simulation) -- ch16: Segmentation This program (segmentation.py) allows you to see how address translations are performed in a system with segmentation. See the README for details.
